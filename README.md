...
> ⚙️ This dashboard is generated by a **GitHub Action running in my own profile repo** (see `metrics.yml`), not a shared third-party server. It refreshes automatically every day and includes language breakdown, a full-year contribution calendar, achievements, and recent activity in one view.
